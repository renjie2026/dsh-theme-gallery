...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const BUNDLED_THEMES = [
      {
        ...
        "tokens": {
          ...
          "--dsw-specific-sidebar-fill": {
            "light": "linear-gradient(to bottom,#EAF5FF 0%,#DDF0FF 26%,#CDE9FB 52%,#BFE2F6 74%,#B0D9F0 100%)",
            "dark": "linear-gradient(to bottom,#EAF5FF 0%,#DDF0FF 26%,#CDE9FB 52%,#BFE2F6 74%,#B0D9F0 100%)"
          }
        },
        "reading": {
          "colorScheme": "light",
    ...
    const AMBIENT_CSS = [
      ...
      '.dsh-amb-control-scene .dof-corner{position:absolute;top:-14%;left:-30%;width:150%;height:46%;',
      'background:radial-gradient(ellipse at 30% 30%,rgba(255,255,255,.85),rgba(255,255,255,0) 62%);',
      'filter:blur(10px);animation:dsh-amb-wash 18s ease-in-out infinite alternate}',
      ...
      '55%{transform:translate(1em,-11em) scale(1)}100%{transform:translate(-.6em,-23em) scale(.8);opacity:0}}',
      ...
      '50%{transform:translate(-.8em,-13em) scale(1)}100%{transform:translate(.5em,-26em) scale(.85);opacity:0}}',
      ...
      '#dsh-theme-ambient .dof-corner{position:absolute;top:-14%;left:-30%;width:150%;height:46%;',
      'background:radial-gradient(ellipse at 30% 30%,rgba(255,255,255,.85),rgba(255,255,255,0) 62%);',
      'filter:blur(10px);animation:dsh-amb-wash 18s ease-in-out infinite alternate}',
    ...
    function dreamAmbientScene(bubbles, motes, fish) {
      ...
      return open('div', { class: 'dof', style: 'position:absolute;inset:0;display:block' })
        ...
        + open('div', {
          class: 'dof-corner',
          style: 'position:absolute;top:-14%;left:-30%;width:150%;height:46%;'
            + 'background:radial-gradient(ellipse at 30% 30%,rgba(255,255,255,.85),rgba(255,255,255,0) 62%);'
            + 'filter:blur(10px);animation:dsh-amb-wash 18s ease-in-out infinite alternate',
        }) + '</div>'
        + open('div', {
...
/**
    ...
    function seaweedMarkup() {
      ...
      return open('svg', {
        ...
        + open('stop', { offset: '0', 'stop-color': '#1F6B57' }) + '</stop>'
        + open('stop', { offset: '0.55', 'stop-color': '#3E9C82' }) + '</stop>'
        + open('stop', { offset: '1', 'stop-color': '#9FE3D2', 'stop-opacity': '0.85' }) + '</stop>'
        + '</linearGradient>'
        + open('linearGradient', { id: 'dsh-dof-weed-b', x1: '0', y1: '1', x2: '0', y2: '0' })
        + open('stop', { offset: '0', 'stop-color': '#2B7C87' }) + '</stop>'
        + open('stop', { offset: '0.6', 'stop-color': '#4FA9B1' }) + '</stop>'
        + open('stop', { offset: '1', 'stop-color': '#B3E8EC', 'stop-opacity': '0.85' }) + '</stop>'
        + '</linearGradient>'
        + open('linearGradient', { id: 'dsh-dof-weed-c', x1: '0', y1: '1', x2: '0', y2: '0' })
        + open('stop', { offset: '0', 'stop-color': '#5568AC' }) + '</stop>'
        + open('stop', { offset: '0.6', 'stop-color': '#7B92CA' }) + '</stop>'
        + open('stop', { offset: '1', 'stop-color': '#CFD9F2', 'stop-opacity': '0.8' }) + '</stop>'
        + '</linearGradient>'
        + '</defs>'
     ...
     * fin, and the three-part eye, in the source colours (`#38bdf8` body, `#1d4ed8` fins).
    ...
    function fishMarkup(suffix, size, top, duration, delay, flip) {
      ...
      return open('div', {
        ...
        + open('path', {
          ...
          fill: '#38bdf8', stroke: '#1d4ed8', 'stroke-width': '1',
        }) + '</path>'
        // Tail
        + open('path', {
          d: 'M10 10 L5 7 L5 13 Z',
          fill: '#1d4ed8', stroke: '#1d4ed8', 'stroke-width': '1', class: 'dof-fish-tail',
        }) + '</path>'
        // Dorsal fin
        + open('path', {
          d: 'M20 7 L25 3 L30 7',
          fill: '#1d4ed8', stroke: '#1d4ed8', 'stroke-width': '1',
        }) + '</path>'
        // Pectoral fin
        + open('path', {
        ...
        + open('circle', { cx: '41', cy: '8', r: '1', fill: '#0B1220' }) + '</circle>'
